...
| API-TEXT-001 | `runtime/core/include/p8/text.h`, `runtime/core/include/p8/wasm.h`, and `apps/web/src/runtime/text-run-ir.ts` | Raw P8SCII execution result plus canonical little-endian ordered semantic text runs and diagnostic correspondence regions | VM, HD text adapter, diagnostics, validation |
