...
| JOB-INTEGRATE-001 | Workspace, HD map, asset pack | Playable adapter build | Bind HD presentation without state mutation |
| JOB-VALIDATE-001 | Builds, replay, checkpoints | DATA-VALIDATION-001 | Prove state/frame/audio/platform invariants |
| JOB-PACKAGE-001 | Validated build and release profile | DATA-RELEASE-001 plus artifacts | Produce reproducible platform packages |
